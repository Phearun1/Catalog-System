    ...
    <nav className="bg-white drop-shadow-md p-4">
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div className="mx-auto items-center ">
          <Link to="/login" className="text-blue-800 text-xl border-opacity-20 border-2 border-gray  font-bold font-sans px-4 py-2 hover:bg-gray-200 rounded">Login</Link>
