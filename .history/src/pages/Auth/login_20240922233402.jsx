...
const AuthCard = () => {
  ...
  return (
    <div>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-br from-white to-gray-300 flex items-center justify-center px-4">
        <div className="w-full max-w-lg bg-white p-0 rounded-2xl shadow-lg transform transition-all duration-500 ease-in-out hover:shadow-xl">
          <h2 className="text-3xl font-bold text-g7ay-800 mb-6 text-center">
