...
const AuthCard = () => {
  ...
  return (
    <div>
      <Navbar />
      {/* Flex column to stack vertically and adjust height */}
      <div className="ml-15 min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-white to-gray-300">
        <div className="w-full max-w-md bg-white p-10 rounded-2xl shadow-lg transition-all duration-500 ease-in-out hover:shadow-xl transform -translate-y-16">
